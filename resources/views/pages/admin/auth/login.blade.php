            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                        <div class="card ">
                            <div class="card-header" style="background: linear-gradient(135deg,rgb(205, 71, 125), #fad0c4);">
                                <div class="text-center">
                                    <h4 class="font-weight-bolder p-3 mb-0">
                                        <span class="text-white">MiraHome</span>
                                    </h4>
                                </div>
                            </div>
                            <div class="card-body pb-0">                          
                                <form action="{{route('loginAdmin.store')}}" method="post">
                                    ...
                                    <div class="text-center mb-2">
                                        <button type="submit" name="submit" class="btn w-50" style="background: linear-gradient(135deg,rgb(231, 115, 118), #fad0c4); color: white; border: none;">Đăng nhập</button>
                                    </div>
                                </form>
                            </div>
                            <div class=" text-center  ">
